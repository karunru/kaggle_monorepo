...
class ExperimentConfig(BaseModel):
    ...
    exp_num: str = EXP_NUM
    name: str = Field(default=f"{EXP_NUM}_demographics_integration", description="実験名")
    description: str = Field(
        default="Integrated Demographics embedding for enhanced classification performance",
        description="実験説明",
    )
    tags: list[str] = Field(
        default=["demographics", "embedding", "acls", "squeezeformer", "pytorch_lightning", "physics_features"],
        description="実験タグ",
    )
