"""pydantic-settings based configuration for exp003（系列長グループ化対応）."""
...
class ExperimentConfig(BaseModel):
    ...
    name: str = Field(default="exp003_length_grouped_squeezeformer", description="実験名")
    description: str = Field(default="Length-grouped Squeezeformer with dynamic padding", description="実験説明")
    tags: list[str] = Field(
        default=["imu_only", "squeezeformer", "pytorch_lightning", "length_grouping", "dynamic_padding"],
        description="実験タグ",
    )
...
class PathsConfig(BaseModel):
    ...
    output_dir: str = Field(default="../../outputs/exp003", description="出力ディレクトリ")
...
class TrainerConfig(BaseModel):
    ...
    default_root_dir: str = Field(default="../../outputs/exp003", description="デフォルトルートディレクトリ")
...
class WandbConfig(BaseModel):
    ...
    name: str = Field(default="exp003", description="実行名")
    tags: list[str] = Field(default=["exp003", "imu_only", "squeezeformer"], description="タグ")
...
class LoggingConfig(BaseModel):
    ...
    log_file: str = Field(default="exp003.log", description="ログファイル名")
...
class Config(BaseSettings):
    ...
    # Root directory
    root: str = Field(default="../../outputs/exp003", description="ルートディレクトリ")
    ...
    class Config:
        ...
        env_prefix = "EXP003_"  # 環境変数プレフィックス
