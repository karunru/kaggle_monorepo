"""pydantic-settings based configuration for exp002."""
...
class ExperimentConfig(BaseModel):
    ...
    name: str = Field(default="exp002_imu_only_squeezeformer", description="実験名")
...
class PathsConfig(BaseModel):
    ...
    output_dir: str = Field(default="../../outputs/exp002", description="出力ディレクトリ")
...
class TrainerConfig(BaseModel):
    ...
    default_root_dir: str = Field(default="../../outputs/exp002", description="デフォルトルートディレクトリ")
...
class WandbConfig(BaseModel):
    ...
    name: str = Field(default="exp002", description="実行名")
    tags: list[str] = Field(default=["exp002", "imu_only", "squeezeformer"], description="タグ")
...
class LoggingConfig(BaseModel):
    ...
    log_file: str = Field(default="exp002.log", description="ログファイル名")
...
class Config(BaseSettings):
    ...
    # Root directory
    root: str = Field(default="../../outputs/exp002", description="ルートディレクトリ")
    ...
    class Config:
        ...
        env_prefix = "EXP002_"  # 環境変数プレフィックス
