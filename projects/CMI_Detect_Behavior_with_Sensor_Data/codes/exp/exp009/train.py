...
def train_single_fold(config: Config, fold: int, logger, wandb_logger) -> dict:
    ...
    model = CMISqueezeformer(
        ...
        id_to_gesture=data_module.train_dataset.id_to_gesture if hasattr(data_module, "train_dataset") and hasattr(data_module.train_dataset, "id_to_gesture") else None,
    )
