"""pydantic-settings based configuration for exp005（Length Grouping + Schedule Free統合）."""
...
class ExperimentConfig(BaseModel):
    ...
    name: str = Field(default="exp005_length_grouped_schedulefree_squeezeformer", description="実験名")
    description: str = Field(
        default="Length-grouped Squeezeformer with Schedule Free optimizers", description="実験説明"
    )
    tags: list[str] = Field(
        default=["imu_only", "squeezeformer", "pytorch_lightning", "length_grouping", "schedule_free"],
        description="実験タグ",
    )
...
class PathsConfig(BaseModel):
    ...
    output_dir: str = Field(default="../../outputs/exp005", description="出力ディレクトリ")
...
class TrainerConfig(BaseModel):
    ...
    default_root_dir: str = Field(default="../../outputs/exp005", description="デフォルトルートディレクトリ")
...
class WandbConfig(BaseModel):
    ...
    name: str = Field(default="exp005", description="実行名")
    tags: list[str] = Field(default=["exp005", "length_grouping", "schedule_free", "squeezeformer"], description="タグ")
...
class LoggingConfig(BaseModel):
    ...
    log_file: str = Field(default="exp005.log", description="ログファイル名")
...
class Config(BaseSettings):
    ...
    # Root directory
    root: str = Field(default="../../outputs/exp005", description="ルートディレクトリ")
