"""CMI 2025 Submission - exp029用推論パイプライン(Demographics統合版、multi-head KL divergence対応)."""
...
def predict(sequence: pl.DataFrame, demographics: pl.DataFrame) -> str:
    ...
    with torch.no_grad():
        for batch in dataloader:
            ...
            for model in models:
                # exp029用multi-head推論
                multiclass_logits, binary_logits, nine_class_logits = model(imu, attention_mask, demographics_batch)
