"""exp007用のテストファイル（欠損値をattention_maskで処理）."""
...
def test_pydantic_config():
    ...
    try:
        ...
        assert EXP_NUM == "exp007"
        print("✓ EXP_NUM correctly set to exp007")
...
def test_basic_functionality():
    ...
    try:
        ...
        try:
            ...
            attention_mask = torch.ones(1, 100, dtype=torch.bool)  # exp007では attention mask 必須
