"""pydantic-settings based configuration for exp007（欠損値をattention_maskで処理）."""
...
class ExperimentConfig(BaseModel):
    ...
    name: str = Field(default=f"{EXP_NUM}_missing_value_attention_mask", description="実験名")
    description: str = Field(default="Missing value handling with attention mask", description="実験説明")
    tags: list[str] = Field(
        default=["imu_only", "squeezeformer", "pytorch_lightning", "missing_value_mask"],
        description="実験タグ",
    )
