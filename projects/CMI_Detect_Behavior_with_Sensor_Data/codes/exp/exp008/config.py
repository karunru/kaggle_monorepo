"""pydantic-settings based configuration for exp008（val_lossでearly stopping）."""
...
class ExperimentConfig(BaseModel):
    ...
    tags: list[str] = Field(
        default=["imu_only", "squeezeformer", "pytorch_lightning", "early_stopping_loss"],
        description="実験タグ",
    )
...
class ModelCheckpointConfig(BaseModel):
    ...
    filename: str = Field(default="epoch-{epoch:02d}-val_loss-{val_loss:.4f}", description="ファイル名形式")
