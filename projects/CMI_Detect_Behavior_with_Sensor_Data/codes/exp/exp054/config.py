...
class ExperimentConfig(BaseModel):
    ...
    exp_num: str = EXP_NUM
    name: str = Field(default=f"{EXP_NUM}_sequence_statistics_features", description="実験名")
    description: str = Field(
        default="Add sequence-level statistical features (min, max, mean, median, percentiles, skew, std) and zero-crossing counts for enhanced behavior detection",
        description="実験説明",
    )
    tags: list[str] = Field(
        default=[
