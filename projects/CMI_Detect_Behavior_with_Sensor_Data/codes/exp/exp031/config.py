...
class ExperimentConfig(BaseModel):
    ...
    exp_num: str = EXP_NUM
    name: str = Field(default=f"{EXP_NUM}_mish_activation", description="実験名")
    description: str = Field(
        default="Mish activation function implementation with IMU-only LSTM, human normalization, and demographics",
        description="実験説明",
    )
    tags: list[str] = Field(
        default=[
