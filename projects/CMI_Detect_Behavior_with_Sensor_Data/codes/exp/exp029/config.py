...
class ExperimentConfig(BaseModel):
    ...
    exp_num: str = EXP_NUM
    name: str = Field(default=f"{EXP_NUM}_imu_only_lstm_hn_demographics_multihead", description="実験名")
    description: str = Field(
        default="IMU-only LSTM with human normalization, demographics, and multi-head KL divergence",
        description="実験説明",
    )
    tags: list[str] = Field(
        default=[
