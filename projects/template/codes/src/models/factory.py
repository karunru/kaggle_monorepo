...
from .gnn import SurvivalGNNModel
from .ktb import KTBoost
from .lightgbm import LightGBM
from .litnn import PairwiseRankingNN
...
def litnn() -> PairwiseRankingNN:
    return PairwiseRankingNN()


def gnn() -> SurvivalGNNModel:
    return SurvivalGNNModel()
